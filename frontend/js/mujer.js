...
async function cargarProductosCatalogo(reiniciar = false) {
    ...
    try {
        ...
        if (reiniciar) {
            productosMujer = [...productos];
        } else {
            productosMujer = [...productosMujer, ...productos];
        }
...
function mostrarCargandoProductos() {
    ...
    if (contador) {
        contador.textContent = "WOMAN COLLECTION / CARGANDO...";
    }
...
function mostrarErrorProductos() {
    ...
    if (contador) {
        contador.textContent = "WOMAN COLLECTION / ERROR";
    }

    if (grid && productosMujer.length === 0) {
...
function renderizarProductos(productos, reiniciar = true) {
    ...
    contador.textContent = `WOMAN COLLECTION / ${totalProductosCatalogo} PRODUCTOS`;
...
function crearCardProducto(producto) {
    ...
    card.className = "tarjeta-mujeres";
