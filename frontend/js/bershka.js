...
function renderizarProductos(productos, reiniciar = true) {
    ...
    contador.textContent = `TREND EDIT / ${productos.length} PRODUCTOS`;
...
function obtenerProductosFiltrados() {
    ...
    let filtrados = [...productosBershka];
...
async function iniciarBershka() {
    try {
        ...
        productosBershka = mezclarArray([...productos]);
        renderizarProductos(productosBershka, true);
