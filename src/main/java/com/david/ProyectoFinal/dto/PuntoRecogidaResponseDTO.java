...
public class PuntoRecogidaResponseDTO {
    ...
    public PuntoRecogidaResponseDTO() {
    }

    public PuntoRecogidaResponseDTO(Long id, String nombre, String direccion, String ciudad, String provincia, Boolean disponible, String motivoNoDisponible) {
        this.id = id;
        this.nombre = nombre;
